        ...
        <footer id='foot' className='border-t-2 border-white'>
            <div className='m-auto max-w-[76vw] pt-28 pb-72'>
                ...
                <div className='mt-28 flex justify-around flex-wrap gap-x-36 gap-y-16 w-4/5 mx-auto'>
                    <SocialCard src='/social/gmail.png' name='Gmail' link='mailto:sa400919@gmail.com' />
            ...
            <div className="text-center py-10 border-t-2 border-white">&copy;{new Date().getFullYear()} ALL RIGHTS RESERVED | WEBSITE CREATED & MAINTAINED BY SAHIL ALAM</div>
        </footer>
    )
}
