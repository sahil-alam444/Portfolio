    ...
    <div id='h1' className='max-lg:block flex my-48'>
      ...
      <div className="w-1/2 flex flex-col justify-center items-center">
        ...
        <span className='flex gap-4 place-self-end mr-24'>
          ...
          <a href="/Sahil%20Alam%20Resume.pdf" className={`text-2xl  hover:scale-110 hover:delay-0 hover:duration-200  ${animate ? 'translate-x-0 ease-out duration-[1s] delay-[0.8s] opacity-100' : '-translate-x-[40%] opacity-0'}`}>Download Resume</a>
        </span>
      </div>
    </div>
  );
